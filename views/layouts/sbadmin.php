...
<head>
    ...
    <!-- MetisMenu CSS -->
    <link href="<?= Yii::getAlias('@web') ?>/sbadmin/metisMenu/metisMenu.min.css" rel="stylesheet">

    <!-- Custom CSS -->
    <link href="<?= Yii::getAlias('@web') ?>/sbadmin/dist/css/sb-admin-2.css" rel="stylesheet">

    <!-- Morris Charts CSS -->
    <link href="<?= Yii::getAlias('@web') ?>/sbadmin/morrisjs/morris.css" rel="stylesheet">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li>
                            ...
                            <?php }else{ ?>
                                <?= Html::a('Logout('.Yii::$app->user->identity->username.')', Url::to(['/site/logout']), ['data-method' => 'POST']) ?>
                            <?php } ?>
                        </li>
                    </ul>
                    <!-- /.dropdown-user -->
